...
//    "'%value%' exceeds the allowed length" => "Wartość '%value%' przekroczyła dozwoloną długość",
    ...
    "Invalid type given. String expected" => "Niepoprawny format adresu email",
    "'%value%' is no valid email address in the basic format local-part@hostname" => "Niepoprawny format adresu emai",
    "'%hostname%' is no valid hostname for email address '%value%'" => "Niepoprawny format adresu email",
    "'%hostname%' does not appear to have a valid MX record for the email address '%value%'" => "Niepoprawny format adresu email",
    "'%hostname%' is not in a routable network segment. The email address '%value%' should not be resolved from public network" => "Niepoprawny format adresu email",
    "'%localPart%' can not be matched against dot-atom format" => "Niepoprawny format adresu email",
    "'%localPart%' can not be matched against quoted-string format" => "Niepoprawny format adresu email",
    "'%localPart%' is no valid local part for email address '%value%'" => "Niepoprawny format adresu email",
    "'%value%' exceeds the allowed length" => "Niepoprawny format adresu email",
    "'%hostname%' is not a valid hostname for email address '%value%'" => "Niepoprawny format adresu email",
    ...
    // App_Validate_Csrf
    "This form is invalid" => "Ten formularz jest nieaktualny",
    "This form is incorrect" => "Ten formularz jest niepoprawny",
    ...
    //Modify crsf error
    "Sorry, an error form. Please try again" => "Przepraszamy, wystąpił błąd formularza. Prosimy spróbować ponownie",
    
    // Own messages Zend_Validate_Regex
    "Value '%value%' is not valid GaduGadu number" => "Wartość '%value%' nie jest poprawnym numerem GaduGadu",
    "Value '%value%' is not valid Cellphone number" => "Wartość '%value%' nie jest poprawnym numerem telefonu komurkowego",
    "Value '%value%' is not valid Phone number" => "Wartość '%value%' nie jest poprawnym numerem telefonu",
    "Value '%value%' is not valid Fax number" => "Wartość '%value%' nie jest poprawnym numerem fax",
    "Price can not be negative" => "Cenia nie może być ujemna",
    "A permalink for '%value%' was found" => "Permalink dla nazwy '%value%' już istnieje",
    
    //Own messages for Extlib_Validate_SmallerThen
    "Value '%value%' must be less than base value" => "Wartość '%value%' musi być mniejsza niż wartość podstawowa",
    "Value '%value%' must be less than base price" => "Wartość '%value%' musi być mniejsza niż cena podstawowa",
    
    //Qunique multifields 
    "Value '%value%' is not unique" => "Znaleziono rekord dla '%value%'",
    
    "'%value%' is not a valid email address." => "'%value%' nie jest poprawnym adresem email",
    
    //Csrf form validation
    "Sorry, an error protection form. Please try again." => "Przepraszamy, wystąpił błąd zabezpieczenia formularza. Proszę spróbować ponownie.",
);